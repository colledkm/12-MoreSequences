...
def run_test_generate_points_on_circle():
    ...
    # Test 2:
    expected = [rg.Point(80, 100),  # All numbers are approximate.
                rg.Point(59.3, 128.5),
                rg.Point(25.7,117.6),
                rg.Point(25.73,82.4),
...
def run_test_draw_points_on_circle():
    ...
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  400 red dots.'
    window = rg.RoseWindow(400, 400, title)
...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 1:  100 slices, thick (thickness=5) black lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 200)
...
def run_test_polygon():
    ...
    # Tests 3:
    title = ('POLYGON tests 3:  4 segments with thin black lines.')
    window = rg.RoseWindow(550, 400, title)
...
def run_test_fancy_polygon():
    ...
    title = ('FANCY POLYGON test 4:  20 purple lines on orange circle,'
             + ' hops = 7.')
    window = rg.RoseWindow(500, 360, title)
